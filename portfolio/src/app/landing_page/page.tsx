        ...
        <>
            ...
            <div className=" roboto hero flex flex-col h-auto pt-10 gap-y-8 bg-light_pink overflow-hidden">
                <div className="nav_bar min-w-full flex-wrap  h-12 flex items-center justify-between pl-32 pr-32">
                    ...
                    <div className="logo pl-6 pr-6 pt-3 pb-3 rounded bg-black relative flex items-center justify-center text-sm font-bold ">Let's Talk</div>
                </div>
                <div className="container h-[518px] pl-[124px] pr-[90px] flex-row  gap-12  flex ">
                    <div className="header_content w-[457px] h-[518px] pt-16 pb-20 flex flex-col gap-12 ">
                        <div className="section_headings  text-black flex flex-col gap-y-4 ">
                            ...
                            <h1 className="tittle font-mono font-extrabold text-5xl leading-normal">Hi There, I'm <span className='text-primary'>Eesha Niaz</span></h1>
                ...
                <div className="testimonials_container w-[74.5rem] h-[16.25rem]  pl-[3rem] pt-[4rem] text-center  justify-center items-center flex flex-col gap-8">
                    ...
                    <div className="testimonial w-[74.5rem] h-[4.5rem] flex justify-between ">
                        ...
                        <div className="message w-[48rem] text-light_black h-[4.5rem]">
                            <p className='font-normal text-4 leading-6 '>Eesha's designs are both visually captivating and highly effective. She transformed our website, enhancing user engagement and conversions. Her attention to detail and creative approach are top-notch. Highly recommended!</p>
                        </div>
                        <div className="arrow_left">
                        <Image 
                    ...
                    <div className="client_imgOrInfo w-[23rem] h-[4.375rem] items-center flex gap-4">
                        ...
                        Eesha Niaz <span className='text-light_black font-normal'>/ CEO of XYZ Company</span>
                         </div>
                    </div>
                </div>
                    ...
                    <div className="contactInfoContainer w-[34.75rem] h-[19.875rem] flex flex-col gap-16 ">
                        ...
                        <div className="contactInfo h-[8.5rem]  w-[34.75rem] flex flex-col gap-8">
                            ...
                            <div className="frame02 w-[291px] h-6 flex gap-4">
                                ...
                                <p className=' text-base font-normal leading-6 text-light_black'> contact@sarajonesdesign.com</p>
                            </div>
                            <div className="frame03 w-[566px] h-6 flex gap-4">
                                <div className="location w-[50px] h-[50px] text-black  text-[25px]">
                                <FaLocationDot />
                                </div>
                                <p className=' text-base font-normal leading-6 text-light_black'>1234 Design Street,Creativeville, Webland,Imaginary State, 98765</p>
                            </div>
                        </div>
                    </div>
